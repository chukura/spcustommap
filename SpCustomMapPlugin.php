...
class SpCustomMapPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Custom Craft Commerce product mapping');
    }
    ...
    {
        return 'https://github.com/kojint/spcustommap/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/kojint/spcustommap/master/releases.json';
    }
    ...
    public function searchPlus_addAlgoliaMapping()
    {
      return [
        [
          'name' => 'Commerce Basic Mapping',
          'handle' => 'commerce_index',
          'description' => 'Craft Commerce Basic Product Indexing',
          'method' => 'SpCustomMap.newMapping'
        ],
      ];
    }
}